...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220707072754_AddItems')
BEGIN
...
BEGIN
    CREATE TABLE [Pago] (
        ...
        CONSTRAINT [FK_Pago_Categoria_id_categoria] FOREIGN KEY ([id_categoria]) REFERENCES [Categoria] ([Id_categoria]) ON DELETE NO ACTION
    );
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220707072754_AddItems')
BEGIN
    CREATE UNIQUE INDEX [IX_Pago_id_categoria] ON [Pago] ([id_categoria]) WHERE [id_categoria] IS NOT NULL;
END;
...
BEGIN
    ...
    VALUES (N'20220707072754_AddItems', N'3.1.2');
END;
